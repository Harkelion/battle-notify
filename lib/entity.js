...
module.exports = function EntityManager(mod, debug) {
  ...
  //       if (message == 2) {
  //         event.message = `We will have a meeting with you in 5 minutes in a private voice call where you will answer our questions. Thanks for the understanding and trying to keep this server script free and fair for everybody.`;
  //       }
  //       if (message == 3) {
  //         mod.send("S_EXIT", 3, {
  //           category: 0,
